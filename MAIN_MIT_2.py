...
def get_args():
    ...
    # Modifica del percorso di salvataggio: verrà creata la cartella "results of reviewer/MIT results"
    parser.add_argument('--save_folder', type=str, default='results of reviewer/MIT results', help='save folder')
...
def main():
    args = get_args()
    for e in range(10):
        # Creazione del percorso: "results of reviewer/MIT results/ExperimentX"
        save_folder = os.path.join('results of reviewer', 'MIT results', f'Experiment{e + 1}')
...
def small_sample():
    ...
    num_battery = 2
    for e in range(10):
        # Creazione del percorso: "results of reviewer/MIT results (small sample num_battery)/ExperimentX"
        save_folder = os.path.join('results of reviewer', f'MIT results (small sample {num_battery})', f'Experiment{e + 1}')
        setattr(args, 'save_folder', save_folder)
