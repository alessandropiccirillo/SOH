...
def get_args():
    ...
    # Il percorso di salvataggio aggiornato: i risultati saranno salvati in "results of reviewer/HUST results"
    parser.add_argument('--save_folder', type=str, default='results of reviewer/HUST results', help='save folder')
...
def main():
    args = get_args()
    for e in range(10):
        # Creazione del percorso: "results of reviewer/HUST results/Experiment{e+1}"
        save_folder = os.path.join('results of reviewer', 'HUST results', f'Experiment{e+1}')
...
def small_sample():
    ...
    for n in [1, 2, 3, 4]:
        for e in range(10):
            # Creazione del percorso: "results of reviewer/HUST results (small sample {n})/Experiment{e+1}"
            save_folder = os.path.join('results of reviewer', f'HUST results (small sample {n})', f'Experiment{e+1}')
            setattr(args, 'save_folder', save_folder)
...
if __name__ == '__main__':
    ...
    main()
    # Per eseguire la modalità small sample, decommentare:
    # small_sample()
