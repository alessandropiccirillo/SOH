...
class Results:
    def __init__(self, root='../results of reviewer/MIT-MLP results/', gap=0.07):
        self.root = root
...
if __name__ == '__main__':
    ...
    root = '../results of reviewer/MIT-MLP results/'
    # Imposta il file Excel di output
    writer = pd.ExcelWriter('../results of reviewer/MIT-MLP_results.xlsx')
    mit_gap = 0.05  # Gap da utilizzare per il calcolo
    # Definisce l'oggetto results
    results = Results(root, gap=mit_gap)
