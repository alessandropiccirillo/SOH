...
class Results:
    def __init__(self,root='../results/MLP/TJU/',gap=0.07):
        self.root = root
...
if __name__ == '__main__':
    root = '../results of reviewer/TJU-MLP results/' # "XJTU-CNN results" or "XJTU-MLP results"
    writer = pd.ExcelWriter('../results of reviewer/TJU-MLP_results.xlsx')
    tju_gap = 0.07
